...
Thanks for your interest in contributing! Phronesis is a neuro-symbolic
policy language for provably-safe agentic ethical reasoning, with an
Elixir/BEAM reference implementation and a Rust → WASM production
compiler.
...
- [`good` `first`
  `issue`](https://github.com/hyperpolymath/phronesis/labels/good%20first%20issue)
  — Simple Perimeter 3 tasks

- [`help`
  `wanted`](https://github.com/hyperpolymath/phronesis/labels/help%20wanted)
  — Community help needed

- [`documentation`](https://github.com/hyperpolymath/phronesis/labels/documentation)
  — Docs improvements

- [`perimeter-3`](https://github.com/hyperpolymath/phronesis/labels/perimeter-3)
