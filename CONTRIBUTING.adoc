...
* https://github.com/hyperpolymath/phronesis/labels/good%20first%20issue[`+good first issue+`]
— Simple Perimeter 3 tasks
* https://github.com/hyperpolymath/phronesis/labels/help%20wanted[`+help wanted+`]
— Community help needed
* https://github.com/hyperpolymath/phronesis/labels/documentation[`+documentation+`]
— Docs improvements
* https://github.com/hyperpolymath/phronesis/labels/perimeter-3[`+perimeter-3+`]
