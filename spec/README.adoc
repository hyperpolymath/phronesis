...
// @taxonomy: spec/index
= phronesis — Specification Directory
:toc:

== Overview

This directory contains the canonical language/query specification files for phronesis.

== Contents

=== grammar.ebnf
The canonical EBNF grammar for phronesis.
