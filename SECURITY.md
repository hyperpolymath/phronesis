...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/phronesis/security/advisories/new)
...
> **Note:** For encrypted communication, please use GitHub Security Advisories which provides end-to-end encryption.
...
- This repository (`hyperpolymath/phronesis`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/phronesis/security/advisories)
...
When using Phronesis, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/phronesis/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/phronesis/security/advisories/new) or security@hyperpolymath.org |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/phronesis/discussions) |
...
*Thank you for helping keep Phronesis and its users safe.*
