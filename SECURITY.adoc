...
[arabic]
. Navigate to
https://github.com/hyperpolymath/phronesis/security/advisories/new[Report
a Vulnerability]
...
____
*Note:* For encrypted communication, please use GitHub Security
Advisories which provides end-to-end encryption.
____
...
https://github.com/hyperpolymath/phronesis/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/phronesis/discussions[GitHub
Discussions]
...
_Thank you for helping keep Phronesis and its users safe._
