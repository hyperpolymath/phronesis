...
*Correction:* The Phronesis type lattice is only a _bounded lattice_, not necessarily distributive for arbitrary types. However, it is distributive within compatible type families (e.g., numeric types).
...
[[43-record-sublattice-width-subtyping]]
...
[[52-runtime-to-static-type-abstraction]]
...
[[61-knaster-tarski-theorem-application]]
...
[[62-recursive-type-fixed-points-future]]
...
[[81-type-constructors-as-homomorphisms]]
...
. Birkhoff, G. (1967). _Lattice Theory_. AMS.
