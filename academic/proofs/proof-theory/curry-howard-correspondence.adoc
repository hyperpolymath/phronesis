...
[[12-phronesis-type-proposition-correspondence]]
...
[[31-β-reduction-cut-elimination]]
...
[arabic]
. Phronesis has no recursion (grammar restriction)
. Each β-reduction decreases term size
. η-expansion preserves termination
. Therefore, reduction terminates ∎
...
[[43-logical-rules-left-and-right]]
...
[[62-linear-types-future-enhancement]]
...
[[63-capability-as-linear-resource]]
...
[[71-propositions-with-unique-proofs]]
...
[arabic]
. Finite grammar of types
. Subformula property of proofs
. Terminating search procedure ∎
...
[[113-soundness-and-completeness]]
...
[arabic]
. Howard, W. A. (1980). _The Formulae-as-Types Notion of Construction_.
. Girard, J.-Y. (1989). _Proofs and Types_. Cambridge.
. Sørensen, M. H., & Urzyczyn, P. (2006). _Lectures on the Curry-Howard Isomorphism_.
. Pfenning, F. (2001). _Lecture Notes on Natural Deduction_.
