...
[[45-phronesis-evaluation-as-catamorphism]]
...
[[83-application-type-equivalence]]
...
[[93-substitution-as-homomorphism]]
...
[arabic]
. Goguen, J., et al. (1977). _Initial Algebra Semantics and Continuous Algebras_. JACM.
. Meijer, E., et al. (1991). _Functional Programming with Bananas, Lenses, Envelopes and Barbed Wire_. FPCA.
. Jacobs, B. (2016). _Introduction to Coalgebra_. Cambridge.
. Baader, F., & Nipkow, T. (1998). _Term Rewriting and All That_. Cambridge.
