...
[[23-separating-implication-magic-wand]]
...
[arabic]
. Reynolds, J. C. (2002). _Separation Logic: A Logic for Shared Mutable Data Structures_. LICS.
. O'Hearn, P. W. (2007). _Resources, Concurrency, and Local Reasoning_. TCS.
. Jung, R., et al. (2015). _Iris: Monoids and Invariants as an Orthogonal Basis for Concurrent Reasoning_. POPL.
. Bornat, R., et al. (2005). _Permission Accounting in Separation Logic_. POPL.
. Vafeiadis, V. (2011). _Concurrent Separation Logic and Operational Semantics_. MFPS.
