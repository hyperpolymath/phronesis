...
. *Log Replication*: All committed entries replicated to majority
. *Safety*: Committed entries never lost
. *Liveness*: Progress after network partition heals
...
* link:Architecture-Consensus.adoc[Architecture-Consensus] - Raft implementation details
* link:Tutorial-Consensus.adoc[Tutorial: Consensus Routing] - Multi-party approval tutorial
* link:Security-Model.adoc[Security Model] - Byzantine fault tolerance
* https://raft.github.io/raft.pdf[Ongaro 2014] - Raft paper
