...
* https://tools.ietf.org/html/rfc4271[RFC 4271] - BGP-4 Specification
* https://tools.ietf.org/html/rfc7454[RFC 7454] - BGP Operations and Security
* https://tools.ietf.org/html/rfc1997[RFC 1997] - BGP Communities
* link:Stdlib-RPKI.adoc[Std.RPKI] - RPKI validation
* link:Tutorial-BGP-Security.adoc[Tutorial: BGP Security] - BGP security tutorial
