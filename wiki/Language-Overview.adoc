...
[arabic]
. *Termination*: All programs terminate (no infinite loops)
. *Type Safety*: Operations are type-checked
. *Sandbox Isolation*: No access to system resources
. *Consensus Gating*: Critical actions require distributed agreement
. *Non-repudiation*: All decisions are logged immutably
...
See link:Reference-Grammar.adoc[Grammar Reference] for complete EBNF.
...
See link:Types.adoc[Types] for details.

'''''

=== Next Steps

* link:Syntax-Reference.adoc[Syntax Reference] - Complete syntax
* link:Types.adoc[Types] - Type system details
* link:Stdlib-RPKI.adoc[Standard Library] - Built-in modules
* link:Formal-Semantics.adoc[Formal Semantics] - Mathematical specification
