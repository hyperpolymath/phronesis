...
Property-based testing generates random inputs to find edge cases. Inspired by https://en.wikipedia.org/wiki/QuickCheck[QuickCheck] and https://github.com/crytic/echidna[Echidna].
...
* link:CLI-Reference.adoc[CLI-Reference] - `phronesis test` command
* link:Architecture-Interpreter.adoc[Architecture-Interpreter] - Execution model
* https://hexdocs.pm/stream_data[Property-Based Testing] - StreamData docs
